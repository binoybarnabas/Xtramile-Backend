...
namespace XtramileBackend.Controllers
{
    ...
    public class RequestController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllRequestAsync()
        {
            try
            {
                IEnumerable<Request> request = await _requestServices.GetAllRequestAsync();
                return Ok(request);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> AddRequestAsync([FromForm] TravelRequestViewModel request)
        {
            try
            {
                ...
                var tblRequest = new Request
                {
                    ...
                    TravelModeId = int.Parse(request.TravelModeId),
        ...
        public async Task<IActionResult> GetRequestByIdAsync(int reqId)
        {
            try
            {
                ...
                Request request = await _requestServices.GetRequestById(reqId);
        ...
        public async Task<IActionResult> updateTravelRequestAsCompleted(UpdateRequest requestDetails)
        {
            try
            {
                await _requestServices.UpdateRequestStatusAsCompleted(requestDetails);
