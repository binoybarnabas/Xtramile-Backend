    ...
    */
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetEmployeesAsync()
        {
            try
            {
                IEnumerable<Employee> employeeData = await _employeeService.GetEmployeeAsync();
        ...
        public async Task<IActionResult> SubmitSelectedTravelOption([FromBody] TravelOptionMap travelOption)
        {
            try
            {
        ...
        public async Task<IActionResult> AddEmployeeProfilePicture(IFormFile profilePicture, int employeeId)
        {
            ...
            {
                var httpContext = HttpContext;
                FileMetaData fileData = await _employeeService.AddEmployeeProfilePicture(profilePicture, employeeId, httpContext);
        ...
        public async Task<IActionResult> GetFileDataById(int fileId)
        {
            try
            {
                FileMetaData fileData = await _fileMetaDataServices.GetFileMetaDataById(fileId);
                return Ok(fileData);
            }
            catch (Exception ex)
            {
