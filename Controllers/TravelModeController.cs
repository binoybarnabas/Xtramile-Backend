...
namespace XtramileBackend.Controllers
{
    ...
    public class TravelModeController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetTravelModesAsync()
        {
            try
            {
                IEnumerable<TravelMode> travelData = await _travelModeService.GetTravelModeAsync();
        ...
        [HttpPost("add")]
        public async Task<IActionResult> AddTravelModeAsync([FromBody] TravelMode travelMode)
        {
            try
            {
